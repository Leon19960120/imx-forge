...
- 📁 **按方向查看**：
  - [D1: 环境完善](directions/d1-environment) - 35项 (6工具 + 29文档)
  - [D2: 工具完备](directions/d2-tools) - 66项 (9工具 + 57文档)
  - [D3: 示例展示](directions/d3-examples) - 11项 (3工具 + 8文档)
  - [D4: 生态成熟](directions/d4-ecosystem) - 18项 (7工具 + 11文档)
- 🎯 **示例项目**：[projects/](projects/)
- 📦 **已完成**：v1.0.0（SD/eMMC 完整构建→烧录→启动闭环，见 [release/v1.0.0.md](../release/v1.0.0.md)）
...
| 类型 | 数量 |
|------|------|
| 工具任务 | 25项 (D1:6 + D2:9 + D3:3 + D4:7) |
| 文档任务 | 105项 (D1:29 + D2:57 + D3:8 + D4:11) |
| **总计** | **130项** |
...
├── todo.md                # 本文件：任务总览
├── directions/            # 发展方向
│   ├── d1-environment.md  # D1: 环境完善 (35项)
│   ├── d2-tools.md        # D2: 工具完备 (66项)
