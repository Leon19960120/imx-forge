...
::: info 本节你将学到
- 作为嵌入式工程师，需要对 Linux 内核理解到什么程度
- **主线内核**与 NXP **linux-imx BSP** 的区别
- 内核源码目录的整体地图，知道每个目录大概干什么
:::

::: tip 前置知识 · 环境
- 已了解 U-Boot 的作用（见 [什么是 U-Boot](../uboot/01_what_is_uboot)）
- 工具链已安装就绪
:::
...
2026年中，主线内核已经发布到 7.1 稳定版了（本项目已在 i.MX6ULL 上实测启动）。对于嵌入式开发来说，选择哪个版本是个问题。最新版功能多、驱动新，但可能有未发现的bug；老版本稳定，但可能不支持你的硬件。i.MX6ULL这种2016年发布的芯片，官方BSP通常基于4.x或5.x的内核（我记得正点是4.1.19。。。），这是因为它需要一个相对稳定的基线。
